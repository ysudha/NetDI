function [dixy, diyx] = DIver2(X,Y,mem,K, down_sample)
%DIver2     Directed Information.
%
%  DIver2 takes as input multiple samples of vectors X and Y, memory, 
...
%
%   Note: DIver2 is similar to DI, except that the X and Y are downsampled
%   in time.
%
...
for i = mem+1 : floor(nlen/down_sample)
